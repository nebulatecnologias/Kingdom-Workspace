// Legal documents shown at /legal/terms and /legal/privacy.
...
const terms: LegalDoc = {
  ...
  sections: [
    ...
    },
    {
      heading: "7. Refunds",
      blocks: [
        "Refunds are handled according to our Refund Policy. To ask for a refund, contact us using the details below. If a purchase is refunded, access to that product is removed from your library.",
      ],
    },
    {
